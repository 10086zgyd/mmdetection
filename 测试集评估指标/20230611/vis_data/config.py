...
log_level = 'INFO'
load_from = '/content/mmdetection/work_dirs/rtmdet_tiny_1xb12-40e_balloon/best_coco/bbox_mAP_epoch_40.pth'
resume = False
train_cfg = dict(
...
data_root = '/content/mmdetection/balloon_dataset/balloon/'
backend_args = None
train_pipeline = [
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/content/mmdetection/balloon_dataset/balloon/val/custom_val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
